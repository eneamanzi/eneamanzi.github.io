...
_Master's Thesis Project (A.Y. 2025/2026)_
...
- Implemented _specified oracles_ directly in each test's code: every check encodes its own evaluation criterion, derived from the domain knowledge of the control under test.
