    ...
    handler: () => {
      window.location.href = "/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/exhibition-webapp.html";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/ftp-server.html";
            },},{id: "projects-template-back-ground-image",
          title: 'Template Back Ground Image',
          description: "with background image",
          section: "Projects",handler: () => {
              window.location.href = "/projects/template-bg-image.html";
            },},{id: "projects-template-redirect-site",
          title: 'Template Redirect Site',
          description: "a project that redirects to another website",
          section: "Projects",handler: () => {
              window.location.href = "/projects/template-redirect-site.html";
            },},{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
